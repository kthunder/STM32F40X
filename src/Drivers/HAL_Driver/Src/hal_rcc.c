...
void RCC_Init()
{
    ...
    // // pll分频设置
    // WRITE_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLM, 4);   // M
    // WRITE_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLN, 168); // N
    // WRITE_BIT(RCC->PLLCFGR, RCC_PLLCFGR_PLLQ, 4);   // Q
    // // SET_BIT(RCC->PLLCFGR, 4 << RCC_PLLCFGR_PLLM_Pos);   // M
    // // SET_BIT(RCC->PLLCFGR, 168 << RCC_PLLCFGR_PLLN_Pos); // N
    // // SET_BIT(RCC->PLLCFGR, 4 << RCC_PLLCFGR_PLLQ_Pos);   // Q
